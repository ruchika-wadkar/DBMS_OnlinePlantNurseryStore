...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="PotsAndPlanters.css">
                    ...
                    <div class="card mt-4 mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <h4>Rs.<?php echo $product['price'];  ?><h4>
                                    <input type="hidden" name="type" value="herbs">
                                    <input type="hidden" name="id" value="<?= $product['id'] ?>">
                                    <input type="hidden" name="name" value="<?= $product['name'] ?>">
                                    <input type="hidden" name="image" img src=".$product['image']."
                                        value="<?= $product['image'] ?>">
                                    <input type="hidden" name="price" value="<?= $product['price'] ?>">
                                    <input type="submit" name="add_to_cart" onclick="clickherbsAlert()"
